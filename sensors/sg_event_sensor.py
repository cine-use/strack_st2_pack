...
SHOTGUN_URL = 'http://strack.shotgunstudio.com'
SHOTGUN_SCRIPT = 'event_daemon'
SHOTGUN_APIKEY = '8589769010d347ae4ed2df76463971dfaf9a3c7ae21dfa68146476593885ad87'
INIT_EVENT_ID = 455068
...
class ShotgunEventSensor(PollingSensor):
    ...
    def setup(self):
        ...
        self._client = Shotgun(SHOTGUN_URL , SHOTGUN_SCRIPT , SHOTGUN_APIKEY )
        ...
        self._fields = ['id', 'event_type', 'attribute_name', 'meta', 'entity', 'user', 'project', 'session_uuid', 'created_at']   
